...
public partial class datagrid : System.Web.UI.Page
{
    ...
    {
        con = new SqlConnection(ConfigurationManager.ConnectionStrings["CnStr"].ConnectionString);
        con.Open();
        cmd.CommandText = "SELECT ProductCode, ProductName, AbsMinSellPrice, MinSellprice, MaxSellPrice, UnitInStore FROM wsStoreItems";
        cmd.Connection = con;
    ...
    public void BindData1()
    {
        con = new SqlConnection(ConfigurationManager.ConnectionStrings["CnStr"].ConnectionString);
        con.Open();
        cmd.CommandText = cmd.CommandText = "SELECT ProductCode, ProductName, AbsMinSellPrice, MinSellprice, MaxSellPrice, UnitInStore FROM wsStoreItems";
        cmd.Connection = con;
        da = new SqlDataAdapter(cmd);
        da.Fill(ds);
