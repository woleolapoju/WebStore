...
public partial class zdatagrid3 : System.Web.UI.Page
{
...
//    SELECT ProductCode, ProductName, Category, ReorderLevel, MaxQty, CostPrice, Discontinue, Pack, Remark, ShelfLocation, AbsMinSellPrice, MinSellprice, MaxSellPrice, UnitInStore, AutoID
//FROM wsStoreItems
    ...
    private void BindGridView()
    {
      ...
      //  string query = "SELECT ProductCode, ProductName, AbsMinSellPrice, MinSellprice, MaxSellPrice, UnitInStore FROM wsStoreItems "; //WHERE Category='" + cboCategory.Text + " Discontinue=0";
      ...
      //  return;
        ...
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["CnStr"].ConnectionString))
        {
            ...
            string strSelectCmd = "SELECT ProductCode, ProductName, Category,AbsMinSellPrice, MinSellprice, MaxSellPrice, UnitInStore FROM wsStoreItems WHERE Discontinue=0 "; // AND Category='" + cboCategory.Text + "'";
